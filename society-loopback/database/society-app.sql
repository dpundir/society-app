...
INSERT INTO `address` VALUES (1,'C-1431','lal bagh','loni','ghaziabad','uttar pradesh','201102'),(2,'C-12','lal bagh','loni','ghaziabad','uttar pradesh','201102'),(3,'B-5','kronos development center, okaya center','sector 62','noida','uttar pradesh','201301'),(9,'C-143','lal bagh','loni','ghaziabad','uttar pradesh','201102'),(12,'flat-1101','crossing replublic',NULL,'ghaziabad','uttar pradesh','201101');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='deposity history details';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `deposit_history` VALUES (1,1,100,0,'2015-12-14 00:00:00',NULL,1),(2,1,10,0,'2015-12-14 00:00:00',NULL,1),(3,2,150,0,'2015-12-14 00:00:00',NULL,1);
...
INSERT INTO `member` VALUES (1,'deepak','singh1','pundir','8287536955',1,'2015-11-13 00:00:00','2015-11-13 00:00:00',1,'1983-11-14',NULL,'surbir','singh','pundir'),(2,'debashis',NULL,'mishra','8882227771',2,'2015-11-30 00:00:00','2015-11-30 00:00:00',1,'1988-11-01',NULL,'d',NULL,'mishra'),(3,'neeraj','a','kumar','1287536955',9,'2015-11-13 00:00:00','2015-11-13 00:00:00',1,'1981-11-14',NULL,NULL,NULL,NULL);
...
INSERT INTO `user` VALUES (1,NULL,NULL,'$2a$10$AWf0x7gnRkf13TaQpF2zHu9g2Hos0yePtGtXFu/y5S86WjHrLhReW','null','null','pundir.friend@gmail.com',1,'eff7a4f82b35148d8f3aaeb004ec8a83bbc095a5b0cb9eecba3e956147115c68f88ed196e4fbbbfa01379fd39d5bd7c40e4991f212044bd496942849d52ea3bc',NULL,NULL,NULL);
...
-- Dump completed on 2015-12-26  0:31:30
